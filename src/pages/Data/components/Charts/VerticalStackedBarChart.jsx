...
const HorizontalStackedBarChart = ({ dataset, title, id }) => {
    ...
    useEffect(() => {
        function handleResize() {
            if (window.innerWidth < 640 && id !== "polnoTabulka2" && id !== "polnoTabulka3") {
        ...
        <div className='w-full mt-10'>
            ...
            <ResponsiveContainer width="90%" height={400} className='mx-auto'>
                ...
                >
                    ...
                    <YAxis type="category" width={80} stroke='white' dataKey="year"/>
