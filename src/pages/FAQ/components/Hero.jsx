...
const Hero = () => {
  return (
    <section className='bg-primary-700 w-full md:min-h-fit min-h-96 md:pt-38 pt-32 relative z-[-1] overflow-hidden pb-32 lg:pb-20'>
        <div className='max-w-[500px] lg:max-w-[800px] desktop:max-w-container m-auto text-primary-100 font-livvic flex flex-col gap-4 lg:gap-12 text-center px-4 lg:px-0 md:gap-8 lg:flex-row lg:text-left lg:gap-0'>
